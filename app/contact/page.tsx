...
const FIELD_CLASS =
    "w-full border border-rule bg-paper-sunken px-4 py-3 text-sm transition-colors focus:border-accent";
    ...
    return (
        <>
            ...
            <div className="container-read py-14">
                ...
                <div className="mt-8 flex items-start gap-3 border border-dashed border-rule-strong p-5">
