 ...
 *
 * 제목(Gowun Dodum)과 손글씨(Gaegu): <link>로 직접 불러온다. `next/font/google`은 이 폰트들의
 ...
 * 로드에 실패해도 --font-display / --font-hand 스택의 다음 폰트로 대체된다.
 */
const FONTS_HREF =
    "https://fonts.googleapis.com/css2?family=Gowun+Dodum&family=Gaegu:wght@400;700&display=swap";
        ...
        <html lang="ko" suppressHydrationWarning>
            ...
            <body className="flex min-h-screen flex-col bg-paper font-sans text-graphite antialiased">
                <Providers>
                    <a
                        href="#main"
                        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:bg-accent focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-accent-on"
                    >
                        본문으로 건너뛰기
                    </a>
                    <Navbar />
